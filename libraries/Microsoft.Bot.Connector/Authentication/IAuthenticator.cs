...
namespace Microsoft.Bot.Connector.Authentication
{
    ...
    public interface IAuthenticator
    {
        ...
        /// <param name="agenticId" >The agentic identifier.</param>
        ...
        public Task<AuthenticatorResult> GetTokenAsync(bool forceRefresh = false, string agenticId = "", string agenticUserId = "", string tenantId = "");
    }
}
